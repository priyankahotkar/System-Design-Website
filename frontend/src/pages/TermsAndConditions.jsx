    ...
    <div className="min-h-screen bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700">
        ...
        <p className="mb-4 text-gray-300">
          Welcome to <strong className="text-indigo-300">Unlimitly</strong>! By accessing or using our platform, including the live collaboration whiteboard, online code editor, interview questions, and discussion forums, you agree to comply with these Terms and Conditions. Please read them carefully.
        </p>

        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">1. Acceptance of Terms</h2>
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">2. Use of the Platform</h2>
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">3. Intellectual Property</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">4. User Accounts</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">5. Termination</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">6. Limitation of Liability</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">7. Changes to Terms</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">8. Governing Law</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-white mt-6 mb-4">9. Contact Us</h2>
        <p className="text-gray-300">
          If you have any questions regarding these Terms and Conditions, please contact us at <a href="mailto:unlimitlytech@gmail.com" className="text-indigo-400 hover:underline">unlimitlytech@gmail.com</a>.
        </p>
      </div>
    </div>
  );
