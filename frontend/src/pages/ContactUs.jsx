...
import { Compass, Mail, Phone, MapPin, Send, MessageSquare, Users, Award, Code } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-8">
            ...
            {submitStatus === "success" && (
              <div className="mb-6 p-4 bg-green-900/50 border border-green-700 rounded-lg">
                <p className="text-green-300 font-medium">Thank you for your message!</p>
            ...
            {submitStatus === "error" && (
              <div className="mb-6 p-4 bg-red-900/50 border border-red-700 rounded-lg">
                ...
                <p className="text-red-400 text-sm">Please try again or contact us directly.</p>
              </div>
            )}
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">unlimitlytech@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+ (91) 9175346605</p>
            ...
            {/* System Design Website Features */}
            <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl shadow-lg p-8 text-white">
              <h2 className="text-2xl font-semibold mb-6 text-center">Explore Our System Design Platform</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="text-center p-4 border border-white/20 rounded-lg">
                  <Compass className="w-8 h-8 mx-auto mb-3" />
                  <h3 className="text-xl font-bold">Live Collaboration Whiteboard</h3>
                  <p className="text-sm mt-1 text-indigo-200">Work with peers in real-time on system design diagrams and workflows.</p>
                </div>
                <div className="text-center p-4 border border-white/20 rounded-lg">
                  <Code className="w-8 h-8 mx-auto mb-3" />
                  <h3 className="text-xl font-bold">Online Code Editor</h3>
                  <p className="text-sm mt-1 text-indigo-200">Practice coding problems directly on our platform with instant execution.</p>
                </div>
                <div className="text-center p-4 border border-white/20 rounded-lg">
                  <Award className="w-8 h-8 mx-auto mb-3" />
                  <h3 className="text-xl font-bold">Interview Questions</h3>
                  <p className="text-sm mt-1 text-indigo-200">Access curated system design and coding questions to prepare for interviews.</p>
                </div>
                <div className="text-center p-4 border border-white/20 rounded-lg">
                  <MessageSquare className="w-8 h-8 mx-auto mb-3" />
                  <h3 className="text-xl font-bold">Discussion Forum</h3>
                  <p className="text-sm mt-1 text-indigo-200">Engage with a community of learners and mentors to discuss designs and solutions.</p>
                </div>
              </div>
            </div>
          </div>
