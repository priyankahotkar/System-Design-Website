...
const Feature = ({ icon: Icon, title, desc }) => (
  <div className="card p-5 h-full">
    <div className="flex items-center gap-3 mb-2">
      <div className="h-9 w-9 rounded-lg bg-indigo-900/50 text-indigo-300 flex items-center justify-center">
    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-900/50 text-indigo-300 text-xs font-medium mb-3">
              <Sparkles className="h-4 w-4" /> Crafted for System Design Learners
            </div>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Learn, Design, and Collaborate — in One Place</h1>
            <p className="text-gray-300 leading-relaxed">
              Hi, I’m <span className="font-semibold text-indigo-300">Priyanka Hotkar</span>. I built SystemDesign Pro to make Low‑Level Design and System Design
          ...
          <div className="hidden md:block">
            <div className="rounded-xl border border-gray-700 bg-gray-800 shadow-lg p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-white">DesignNova</span>
              </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-6">
        <div className="card p-6">
          <h2 className="text-lg font-semibold text-white mb-2">The Story</h2>
          <p className="text-gray-300">
            ...
            <span className="font-medium text-indigo-300"> collaborative whiteboard</span> and a <span className="font-medium text-indigo-300">code editor</span> together, with a community space to learn
            out loud.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="text-center">
          <h3 className="text-lg font-semibold text-white mb-2">Thanks for Being Here</h3>
